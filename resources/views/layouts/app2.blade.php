...
@else
    ...
    <div class="col-md-12 col-lg-4">
        ...
        <div class="card-body">
            ...
            <p class="mb-2 pb-1">Manage all your projects in this website! 🚀</p>
            <p class="mb-0 pb-1">A lot of features can be used here</p>
            <a class="btn btn-primary" style="background-color: #3f58b0;" href="{{ url('pages/account-settings-account') }}">View Profile</a>
        </div>
    ...
    <div class="col-xl-4 col-md-6">
        ...
        <div class="card-body">
            ...
            <div class="d-flex align-items-center gap-3">
                <p class="mb-0">Your productivity has increased by 45% better compared to last month</p>
            </div>
            <div class="d-grid mt-3 mt-md-4">
                <a class="btn btn-primary" style="background-color: #3f58b0;" href="{{ url('/{proj_id}/{sprint_id}/burn-down-chart') }}">Details</a>
            </div>
            </div>
        </div>
        </div>
    ...
    <div class="col-xl-4 col-md-6">
        ...
        <div class="card-body">
            ...
            <div class="d-grid mt-3 mt-md-5">
                <a class="btn btn-primary" href="{{ url('/profeature') }}" style="background-color: #3f58b0;">More Projects</a>
            </div>
            </li>
            </ul>
        </div>
    ...
    <div class="col-xl-4 col-md-6">
        ...
        <div class="col-sm-6">
            <div class="card h-100">
            <div class="card-header pb-0">
                <h5 class="mb-0">Create your sprint here!</h5>
            </div>
            <div class="card-body">
                ...
                {{--
                <div class="d-grid mt-1 mt-md-2">
                    <a class="btn btn-primary" href="{{ url('/home') }}" style="background-color: #3f58b0;">Sprint</a>
                </div>
                --}}
            </div>
            </div>
    ...
    <div class="col-12">
        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <td class="text-truncate">{{$user->user_role}}</td>
                <td class="text-truncate">{{ $user->country }}</td>
                ...
                <td class="text-truncate">Developer</td>
                ...
                <td>
                    ...
                    <td><span class="badge bg-label-danger rounded-pill">Late</span></td>
                ...
                <td>
                    ...
                    <div>
                        <h6 class="mb-0 text-truncate">Tan Cheng Lee</h6>
                        <small class="text-truncate">@tanchenglee</small>
                    </div>
                    </div>
                </td>
                <td class="text-truncate">tanchenglee@gmail.com</td>
                <td class="text-truncate">Project Manager</td>
                <td class="text-truncate">Malaysia</td>
                <td><span class="badge bg-label-success rounded-pill">Active</span></td>
                </tr>
                <tr>
                <td>
                ...
                <td class="text-truncate">Maintainer</td>
                <td class="text-truncate">France</td>
                <td><span class="badge bg-label-success rounded-pill">Active</span></td>
                </tr>
                @can('isAdmin')
                    <tr>
                    ...
                    <td class="text-truncate">Singapore</td>
                    <td><span class="badge bg-label-warning rounded-pill">Pending</span></td>
                    </tr>
                @endcan
                <tr>
                <td>
                    ...
                    <div>
                        <h6 class="mb-0 text-truncate">Ridwan Joko</h6>
                        <small class="text-truncate">@ridwanjoko</small>
                    </div>
                    </div>
                </td>
                <td class="text-truncate">ridwanjoko@gmail.com</td>
                <td class="text-truncate">User</td>
                ...
                @can('isProjectManager')
                    ...
                    <td>
                        ...
                        <td class="text-truncate">Project Manager</td>
                        <td class="text-truncate">United Kingdom</td>
